...
def load_from_checkpoint(checkpoint_path: str, hparams_file_path: Union[str, None],strict=False) -> CometModel:
    ...
    if os.path.exists(hparams_file):
        ...
        print(hparams)
        model = model_class.load_from_checkpoint(checkpoint_path, **hparams,strict=False)
        return model
    else:
